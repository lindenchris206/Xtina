...
export const CpuChipIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5M12 4.5v-1.5m3.75 18v-1.5M12 21v-1.5m-8.25-3.75h1.5m15 0h1.5M12 18.75V21m-3.75-18v1.5m0 15v1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 7.5v1.5h-9V7.5h9Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 15v1.5h-9V15h9Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 7.5v7.5h9V7.5h-9Z" />
  </svg>
);
...
export const FingerPrintIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0 1 19.5 12c0 2.21-1.002 4.217-2.636 5.572M16.5 18.375a3 3 0 0 0-3-3H12a3 3 0 0 0-3 3M12 12.75V15m-3-3V15m6-2.25V15m-3-3.75a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75H12a.75.75 0 0 1-.75-.75V9m1.5-1.5a.75.75 0 0 0-.75-.75H12a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75V7.5m-3 3a.75.75 0 0 0-.75-.75H8.25a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75v-.008m3.75 3a.75.75 0 0 0-.75-.75H12a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75v-.008m-3-6.75a.75.75 0 0 0-.75-.75H8.25a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75v-.008m7.5-3.75a.75.75 0 0 0-.75-.75h-.008a.75.75 0 0 0-.75.75v.008a.75.75 0 0 0 .75.75h.008a.75.75 0 0 0 .75-.75V4.5m-3 3.75a.75.75 0 0 0-.75-.75h-.008a.75.75 0 0 0-.75.75v.008a.75.75 0 0 0 .75.75h.008a.75.75 0 0 0 .75-.75v-.008m0 3.75a.75.75 0 0 0-.75-.75h-.008a.75.75 0 0 0-.75.75v.008a.75.75 0 0 0 .75.75h.008a.75.75 0 0 0 .75-.75v-.008" />
  </svg>
);
 ...
 * @description A versatile file viewer that delegates to specific editors based on MIME type.
 */
...
const isTextFile = (mimeType: string | undefined, filename: string) => 
...
const isPdfFile = (mimeType: string | undefined, filename: string) =>
    mimeType === 'application/pdf' || filename.endsWith('.pdf');

const isWordFile = (mimeType: string | undefined, filename: string) =>
    ...
    if (!activeFile) {
        return (
            <div className="h-full flex flex-col items-center justify-center text-gray-500">
                ...
                <p className="text-sm">Files generated by the crew will appear in the panel to the left.</p>
            </div>
        );
    }
    ...
    const renderContent = () => {
        ...
        return (
            <div className="flex flex-col items-center justify-center h-full text-gray-400 p-4">
                ...
                <p className="text-sm text-gray-500 mb-4">({filename} - {mimeType || 'unknown'})</p>
                <a 
                    href={content} 
                    download={filename}
